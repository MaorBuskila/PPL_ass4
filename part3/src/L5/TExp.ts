...
export type TExp =  AtomicTExp | CompoundTExp | TVar | UserDefinedNameTExp | ClosuerTExp | SymbolTExp | PairTExp; // L51
...
export type ClosuerTExp = { tag: "ClouseTExp" };
export const makeClosuerTExp = (): ClosuerTExp => ({tag: "ClouseTExp"});
export const isClosuerTExp = (x: any): x is ClosuerTExp => x.tag === "ClouseTExp";
